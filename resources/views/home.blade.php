              ...
              <div class="container">
                  ...
                  <div class="row">
                      <div class="col-sm-12">
                          ...
                          <p class="text-muted page-title-alt">Hello <strong style="color:#505458;">{{Auth::user()->name}}</strong>  Welcome to Your First Cart Development</p>
                      </div>
                  </div>
                  <!-- Modal -->
                ...
                {{ csrf_field() }}
                    ...
                    <div class="row">          <!-- End Of Modal -->
                        <div class="col-xs-18 col-sm-6 col-md-3">
                          <div class="thumbnail">
                            <img src="./img/oneplus3t.jpg" alt="">
                              <div class="caption">
                                <h4>OnePlus 3 T </h4>
                                <p>Our sleekest device ever just got sleeker. The OnePlus 3T is now available in stunning, limited edition Midnight Black. Find out why our new color is more than .</p>
                        ...
                        <div class="col-xs-18 col-sm-6 col-md-3">
                          <div class="thumbnail">
                            <img src="./img/oneplus2.jpg" alt="">
                              <div class="caption">
                               <h4>OnePlus 1</h4>
                                <p>OnePlus One MORE PICTURES. Released 2014, June 162g, 8.9mm thickness. Android 4.4.2, up to 6.0.1 16/64GB storage, no card slot; 3.6% 17,201,010 hits ...</p>
                                <p><a href="" class="btn btn-success" role="button">Add To Cart</a></p>
                            </div>
                          </div>
                        </div>
